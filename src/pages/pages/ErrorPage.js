...
const ErrorPage = () => {
    return (
        <body className="ErrorPage-body  flex flex-col items-center">
            ...
            <img alt='' className="z-10 cover w-2/4" src="https://static.vecteezy.com/system/resources/previews/003/454/900/large_2x/error-404-with-the-cute-coffee-cup-mascot-free-vector.jpg" />
