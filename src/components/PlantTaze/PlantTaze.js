...
const PlantTaze = () => {
	...
	return (
		<section className="plantTaze flex flex-row h-auto">
			...
			<article className="plantTaze flex flex-col p-4 justify-center">
